...
function Sidebar() {
    return (
        <nav className="bg-white w-64 h-screen border-r border-gray-400">
            <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-400">
                <div className="bg-[#1D4ED8]">
                    <Link to="/">
                        <img src={AppLogo} alt="Logo" className="h-30 w-30 object-contain " />
                    </Link>
                </div>
            </div>
            ...
            <ul className="mt-3 space-y-3 px-7">
                <li className="flex items-center gap-3 mb-5">
                    <Link to="/" className="flex items-center gap-3 py-2 px-6 text-gray-700 rounded-lg hover:border-2 hover:border-blue-200 hover:text-bue-700 transition-all duration-200">
