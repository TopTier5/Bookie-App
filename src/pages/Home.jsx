        ...
        <>
            <div className="flex h-screen">
                ...
                <div className="flex flex-col flex-1">
                    <Navbar />
                    <hero className="p-6 bg-white flex-1 overflow-auto">
                        ...
                        <div className=" mt-7 bg-blue-100 p-4 rounded-lg shadow-md mb-6"><h2 className="text-xl font-semibold text-blue-900">📚 Trending Reads</h2>
                        </div>
